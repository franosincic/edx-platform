...
def get_courses_accessible_to_user(request, this_user=None):
    ...
    if GlobalStaff().has_user(user):
        ...
        courses, in_process_course_actions = _staff_accessible_course_list(request, user)
    else:
        try:
...
def _staff_accessible_course_list(request, this_user=None):
    """
    ...
    def course_filter(course_summary):
        ...
        return has_studio_read_access(user, course_summary.id)

    courses_summary = filter(course_filter, modulestore().get_course_summaries())
    in_process_course_actions = get_in_process_course_actions(request, user)
...
def get_in_process_course_actions(request, this_user=None):
    """
